...
Shader "Raygeas/Suntail Foliage"
{
	...
	SubShader
	{
		...
		float4 shadowmaskcatch782( float2 LM_uv )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 temp_output_781_0 = ( ( i.uv2_texcoord2 * (unity_LightmapST).xy ) + (unity_LightmapST).zw );
			float2 LM_uv782 = temp_output_781_0;
			float4 localshadowmaskcatch782 = shadowmaskcatch782( LM_uv782 );
			float temp_output_783_0 = (localshadowmaskcatch782).x;
			float clampResult786 = clamp( exp2( temp_output_783_0 ) , 0.0 , 1.0 );
			float4 temp_cast_1 = (clampResult786).xxxx;
			float4 lerpResult787 = lerp( _shadowcolor1 , temp_cast_1 , temp_output_783_0);
			float4 shadowmask788 = lerpResult787;
			float3 temp_output_766_0 = (UNITY_SAMPLE_TEX2D( unity_Lightmap, temp_output_781_0 )).rgb;
			float3 decodeLightMap769 = DecodeLightmap(float4( temp_output_766_0 , 0.0 ));
			float3 LMPower774 = ( decodeLightMap769 * _LM_Power1 );
			...
			float4 blendOpSrc789 = float4( LMPower774 , 0.0 );
			float4 blendOpDest789 = ( IndirectLight612 + DirectLight614 + Translucency631 + float4( Smoothness734 , 0.0 ) );
			float grayscale775 = Luminance(temp_output_766_0);
			float4 lerpBlendMode789 = lerp(blendOpDest789,( blendOpSrc789 * blendOpDest789 ),grayscale775);
			c.rgb = ( shadowmask788 * ( saturate( lerpBlendMode789 )) ).rgb;
			c.a = 1;
...
/*ASEBEGIN
Version=18912
575;44;1361;1019;2203.711;561.0264;2.263184;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;743;-3160.938,-1211.943;Inherit;False;Property;_WorldScale;World Scale;12;0;Create;True;0;0;0;False;0;False;1;3.44;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;746;-2468.205,491.303;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;-2435.594,-863.7374;Inherit;False;Property;_SecondColorFade;Fade;11;0;Create;False;0;0;0;False;0;False;0.5;0.82;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;310;-2470.071,-1007.13;Inherit;False;Property;_SecondColorOffset;Offset;10;0;Create;False;0;0;0;False;0;False;0;-0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3;-4818.124,-1419.369;Inherit;False;Property;_MainColor;Main Color;4;0;Create;True;0;0;0;False;2;Header(Settings);Space(5);False;1,1,1,0;0.1992481,0.5,0.4172932,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;247;-4815.405,-1025.55;Inherit;False;Property;_SecondColor;Second Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.02352945,0.2,0.02000001,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;340;-3897.969,-1336.19;Inherit;False;Property;_Color2Enable;Enable;7;0;Create;False;0;0;0;False;2;Header(Second Color Settings);Space(5);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-5429.632,-246.7836;Inherit;False;Property;_WindSpeed;Speed;18;0;Create;False;0;0;0;False;0;False;0.5;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;776;-2461.604,1199.643;Float;False;Global;unity_LightmapST;unity_LightmapST;2;0;Fetch;True;0;0;0;False;0;False;0,0,0,0;0.1403194,0.1403194,0.409795,0.8231544;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;778;-2445.604,1007.643;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;429;-5097.826,1262.879;Inherit;False;Property;_DirectLightOffset;Direct Light Offset;20;0;Create;True;0;0;0;False;2;Header(Lighting Settings);Space(5);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SwizzleNode;777;-2157.603,1199.643;Inherit;False;FLOAT2;0;1;2;3;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;681;-3844.91,758.1143;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;780;-1997.604,1055.643;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SwizzleNode;779;-2157.603,1311.643;Inherit;False;FLOAT2;2;3;2;3;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;708;-3865.462,529.6811;Inherit;True;Property;_SmoothnessTexture;Smoothness;2;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;190;-4866.769,-126.1545;Inherit;False;Property;_WindWavesScale;Waves Scale;17;0;Create;False;0;0;0;False;0;False;0.25;0.411;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;764;-1809.28,889.9647;Float;True;Global;unity_Lightmap;unity_Lightmap;1;0;Fetch;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.LightAttenuation;431;-4589.965,1312.194;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;470;-4049.085,2114.592;Inherit;False;Property;_TranslucencyInt;Translucency Int;23;0;Create;True;0;0;0;False;0;False;1;0;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;781;-1773.604,1231.643;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;458;-3582.498,1206.08;Inherit;False;Property;_IndirectLightInt;Indirect Light Int;22;0;Create;True;0;0;0;False;0;False;1;0;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;457;-4453.205,1585.23;Inherit;False;Property;_DirectLightInt;Direct Light Int;21;0;Create;True;0;0;0;False;0;False;1;0;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;438;-3491.725,1116.984;Inherit;False;259;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.CustomExpressionNode;782;-1629.604,1343.643;Float;False;float4 finalColor = UNITY_SAMPLE_TEX2D( unity_ShadowMask, LM_uv )@$$return finalColor@$;4;Create;1;True;LM_uv;FLOAT2;0,0;In;;Float;False;shadowmaskcatch;True;False;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;434;-4359.882,1505.049;Inherit;False;259;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;765;-1537.144,883.6126;Inherit;True;Property;_TextureSample2;Texture Sample 1;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SwizzleNode;766;-1181.036,867.0516;Inherit;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SwizzleNode;783;-1421.604,1503.643;Inherit;False;FLOAT;0;1;2;3;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;706;-3029.917,563.4495;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-3949.659,38.50756;Inherit;False;Property;_WindForce;Force;15;0;Create;False;0;0;0;False;0;False;0.3;0.48;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;376;-3793.085,-237.1686;Inherit;False;Property;_Anchorthefoliagebase;Anchor the foliage base;19;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;770;-952.9316,982.0964;Inherit;False;Property;_LM_Power1;LM_Power;16;0;Create;True;0;0;0;False;0;False;0;1;0;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;768;-1200.081,1396.624;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;767;-972.4085,1075.791;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DecodeLightmapHlpNode;769;-991.3555,806.4216;Inherit;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Exp2OpNode;784;-1309.604,1423.643;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;773;-742.9316,926.0964;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;772;-1179.081,1374.624;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;771;-909.4086,1086.791;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;785;-1435.296,1167.985;Inherit;False;Property;_shadowcolor1;shadowcolor;13;0;Create;True;0;0;0;False;0;False;0.3679245,0.3679245,0.3679245,1;0.3058823,0.5098038,0.6980392,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;786;-1182.057,1426.249;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;774;-599.3185,864.3731;Float;False;LMPower;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TFHCGrayscale;775;-775.4086,1053.791;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;341;-3278.123,-144.9097;Inherit;False;Property;_EnableWind;Enable;14;0;Create;False;0;0;0;False;2;Header(Wind Settings);Space(5);False;0;1;1;True;;Toggle;2;;;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;787;-1016.029,1253.256;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendOpsNode;789;-227.7858,876.0807;Inherit;False;Multiply;True;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;788;-528.389,1244.844;Inherit;False;shadowmask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;790;85.68838,1234.873;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-4591.908,-725.2592;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;6;0;Create;False;0;0;0;False;0;False;0.35;0.45;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;151;399.8435,-372.3191;Float;False;True;-1;2;;0;0;CustomLighting;Raygeas/Suntail Foliage;False;False;False;False;False;False;True;True;True;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;3;False;558;1;False;559;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;False;-1;10;False;-1;4;1;False;-1;1;False;-1;1;False;-1;1;False;-1;0;False;0.01;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;True;156;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;773;0;769;0
WireConnection;773;1;770;0
WireConnection;772;0;768;0
WireConnection;771;0;767;0
...
WireConnection;789;1;452;0
WireConnection;789;2;775;0
...
WireConnection;151;13;790;0
WireConnection;151;11;236;0
ASEEND*/
//CHKSM=5BD3C5DDEC35A4259F2D240D359BD453263DB9AB